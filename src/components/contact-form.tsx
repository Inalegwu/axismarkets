  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="fixed left-1/2 top-1/2 max-h-[85vh] w-[90vw] max-w-125 -translate-x-1/2 -translate-y-1/2 rounded-sm bg-background-950 border border-solid border-background-900 text-foreground-50 shadow-(--shadow-6) focus:outline-none data-[state=open]:animate-contentShow">
          <div className="flex flex-col gap-3 relative items-start justif-start p-5">
            <div className="flex flex-col items-start gap-1">
              <Dialog.Title className="text-2xl text-foreground-50 font-bold tracking-tight">
                Get In Touch
              </Dialog.Title>
            ...
            <Dialog.Close className="absolute z-1 text-red-500 right-2 top-2">
